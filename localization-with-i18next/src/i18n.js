  ...
  resources: {
    ...
    hin: {
      translations: {
        ...
        'Plugins to load translations':
          'अनुवाद लोड करने के लिए प्लगइन्स',
        'Optionally cache the translations':
          'वैकल्पिक रूप से अनुवाद कैश करें',
        Advantages: 'लाभ',
        'Flexibility to use other packages':
    ...
    ger: {
      translations: {
        Introduction: 'Introduction',
        Engsub: 'testing there',
        'Plugins to detect the user language':
          'Plugins for recognizing the user language',
        'Plugins to load translations':
          'Plugins to load translations',
        'Optionally cache the translations':
          'Optionally store the translations temporarily',
        Advantages: 'Advantages',
        'Flexibility to use other packages':
          'Flexibility to use other packages',
      },
    ...
    fre: {
      translations: {
        ...
        'Plugins to detect the user language':
          'Plugins for the detection of the language of use',
        'Plugins to load translations':
          'Plugins pour charger les traductions',
        'Optionally cache the translations':
